...
internal class WorkloadSetInfo
{
    ...
    public List<WorkloadManifestInfo> Manifests { get; set; } = [];
...
internal class WorkloadSetProperties
{
    ...
    public static WorkloadSetProperties CreateFromWorkloadSetVersion(string workloadSetVersion)
    {
        ...
        ret.SdkFeatureBand = GenerateTestWorkloadSets.WorkloadSetVersion.GetFeatureBand(workloadSetVersion).ToString();
        ret.Version = GenerateTestWorkloadSets.WorkloadSetVersion.ToWorkloadSetPackageVersion(workloadSetVersion, out _);
